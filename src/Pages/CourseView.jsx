...
function CourseView() {
  ...
  return (
    <HomeLayout>
      ...
      <div className='bg-neutral h-[80px] w-[100%] sticky top-0 text-white'>
      ...
      <div className='absolute top-24 h-[85%] right-8'>
        <div className="card w-96 bg-base-100 shadow-xl sticky top-2   ">
      ...
      {
        data && (
          <div className='ml-20 mt-10 w-[60%] space-y-2' >
